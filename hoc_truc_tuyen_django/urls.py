...
urlpatterns = patterns('',
    ...
    url(r'^doimatkhau', 'trac_nghiem.views.change_password'),
    url(r'^profile', 'trac_nghiem.views.profile'),
    url(r'^question-list', 'trac_nghiem.views.question_list'),
    url(r'^edit-question/(?P<id_question>\d+)', 'trac_nghiem.views.edit_question'),
    url(r'^save-question', 'trac_nghiem.views.save_edited_question'),
    url(r'^delete-question/(?P<id_question>\d+)', 'trac_nghiem.views.delete_question'),
    # Uncomment the admin/doc line below to enable admin documentation:
    url(r'^admin/doc/', include('django.contrib.admindocs.urls')),
    url(r'^feedback','trac_nghiem.views.feedback'),
    url(r'^ranking','trac_nghiem.views.ranking'),

    url(r'^cpanel','trac_nghiem.views.cpanel'),
